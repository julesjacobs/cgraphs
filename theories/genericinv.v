...
Section genericinv.
  ...
  Lemma inv_insert_l (v1 v2 : V) (f f' : V -> multiset L -> hProp V L) :
    (* (∀ v, Proper ((≡) ==> (⊣⊢)) (f v)) -> *)
    (∀ v x, v ≠ v1 ∧ v ≠ v2 -> f v x ⊢ f' v x) ->
    (∀ x, f v2 x ⊢ ⌜⌜ x ≡ ε ⌝⌝) ->
    (∀ y, f v1 y ⊢
  ...
  Lemma inv_insert_r (v2 v3 : V) (f f' : V -> multiset L -> hProp V L) :
    (* (∀ v, Proper ((≡) ==> (⊣⊢)) (f v)) -> *)
  ...
  Lemma inv_insert_lr (v1 v2 v3 : V) (f f' : V -> multiset L -> hProp V L) :
    (* (∀ v, Proper ((≡) ==> (⊣⊢)) (f v)) -> *)
    v1 ≠ v2 ∧ v2 ≠ v3 ∧ v3 ≠ v1 ->
